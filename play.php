        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            async function initPlayer() {
                ...
                if (src && !src.includes('/api/proxy/') && !src.includes('/proxy?')) {
                    ...
                    if (sLower.includes('fancode.com') || sLower.includes('akamaized.net/mumbai') || sLower.includes('dai-fancode.pages.dev') || sLower.includes('livetv.hotstar.com') || sLower.includes('live09p.hotstar.com') || sLower.includes('dishmt.slivcdn.com')) {
                        src = `/api/proxy/fancode?url=${encodeURIComponent(src)}`;
                        resolvedSrc = src;
                    }
                }
